...
class Route(object):
    ...
    def tick(self):
        ...
        self.go_next_way_point()  # close idx ++ and update current route
        info = self.get_info()
    ...
    def get_info(self):
        ...
        info['route_completed_in_m_percentage'] = route_comp_mper = self._completed_route_length / self._full_route_length
        info['is_route_finished'] = self.is_route_finished()
