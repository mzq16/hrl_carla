...
class PPO(object):
    ...
    def collect_rollouts(self, env: VecEnv, callback: BaseCallback,
        ...
        pbar = tqdm(total=n_rollout_steps+1)
        ...
        for epoch in range(self.n_epochs):
            ...
            for i in range(data_len):
                ...
                values, log_prob, entropy_loss, exploration_loss, distribution = self.policy.evaluate_actions(
                    ...
                    detach_values=False)
                '''
                values, log_prob, entropy_loss, distribution = self.policy.evaluate_actions(
                    rollout_data.observations, rollout_data.actions, None,   # rollout_data.exploration_suggests,
                    detach_values=False)
                # Normalize advantage
    ...
    def learn(self, total_timesteps, callback=None, seed=2021):
        ...
        while self.num_timesteps < total_timesteps:
            ...
            #print('rollout time:', self.t_rollout)
