...
class my_SACPolicy(BasePolicy):
    ...
    def __init__(
        ...
        super(my_SACPolicy, self).__init__(
            observation_space,
            action_space,
    ...
    def _build(self, lr_schedule: Schedule, diayn=False) -> None:
    ...
    def make_discriminator(self, latent_dim=256, number_z=50):
