...
class DiagGaussianDistribution():
    def __init__(self, action_dim: int, dist_init=None, action_dependent_std=False, device=th.torch.device('cuda:0')):
...
class BetaDistribution():
    def __init__(self, action_dim=2, dist_init=None, device=th.torch.device('cuda:2')):
        assert action_dim == 2
